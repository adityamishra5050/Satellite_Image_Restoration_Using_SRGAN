...
def main():
    while True:
        print("Choose an activity (1-4) or type 0 to exit:")
        print("1. Noise Effect")
        print("2. Vignetting Effect")
        print("3. Chromatic Aberration Effect")
        print("4. Blurr Effect")
        print("5. Striping Effect")

        try:
            choice = int(input("Enter your choice: "))
        except ValueError:
            print("Invalid input. Please enter a number between 1 and 4, or 0 to exit.")
            continue
